...
predictOutCSV <- function(file.output.list, estimate.list, predict.list,
  ...
  predmatrix <- predict.list$predmatrix
  oparmlist <- predict.list$oparmlist
  loadunits <- predict.list$loadunits
  oparmlistExpl <- predict.list$oparmlistExpl
  yldmatrix <- predict.list$yldmatrix
  oyieldlist <- predict.list$oyieldlist
  yieldunits <- predict.list$yieldunits
  oyieldlistExpl <- predict.list$oyieldlistExpl
