---
title: "SPARROW"
author: "Richard Alexander, Lillian Gorman Sanisaca, and Kyle Hurley"
...
Users are directed to download the documentation from <https://code.usgs.gov/water/stats/rsparrow/-/blob/master/RSPARROW_master/inst/doc/RSPARROW_docV2.0.pdf>. This provides a complete guide to the installation and use of RSPARROW, including the steps needed to create and interpret SPARROW models. 
...
3. **R-4.4.2**:  Contains the recommended 4.4.2 version of R, with pre-installed RSPARROW library dependencies. The R library dependencies have been tested for compatibility with RSPARROW. More recent R versions (>4.4.2) may operate with RSPARROW, once the required package dependencies are installed, but full compatibility of these R versions with RSPARROW is not guaranteed. The R-4.4.2 directory should be located separately from the RSPARROW master and User Directories, such as parallel to a user's other versions of R.
...
Gorman Sanisaca, Lillian, Hurley, Kyle P., and Alexander, Richard B.  (2025) [RSPARROW 2.1.0: An R system for SPARROW modeling](ttps://code.usgs.gov/water/stats/RSPARROW) [Software release]. U.S. Geological Survey. DOI: https://doi.org/10.5066/P1Y6RUBU
