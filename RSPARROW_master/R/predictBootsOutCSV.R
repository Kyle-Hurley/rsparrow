...
predictBootsOutCSV <- function(file.output.list, estimate.list, predictBoots.list,
  ...
  bootmatrix <- predictBoots.list$bootmatrix
  boparmlist <- predictBoots.list$boparmlist
  bootyldmatrix <- predictBoots.list$bootyldmatrix
  byldoparmlist <- predictBoots.list$byldoparmlist
