...
#' @return `Vsites.list` named list of sites for validation including
#' \tabular{ll}{
#' `waterid` \tab numeric vector of waterids selected for validation \cr
#' `staid` \tab numeric vector of staids selected for calibration \cr
#' `vstaid` \tab numeric vector of staids selected for validation \cr
#' `depvar` \tab numeric vector of mean load response for `staid` \cr
#' `vdepvar` \tab numeric vector of mean load response for `vstaid` \cr
#' `nMon` numeric vector of `staid` sequence numbers \cr
#' `vic` numeric vector sequence of `vstaid` \cr
#' `staidseq` numeric vector of final sequence of staid generated by `assignIncremSiteIDs()` \cr
#' `vstaidseq` numeric vector of final sequence of vstaid generated by `assignIncremSiteIDs()` \cr
#' }
#' @keywords internal
#' @noRd
