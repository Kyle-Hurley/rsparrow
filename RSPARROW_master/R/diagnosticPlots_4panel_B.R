...
diagnosticPlots_4panel_B <- function(sitedata, plotResids, plot.ratio.obs.pred, plot.standardResids, plotpredict,
  ...
  # Residual plots
  p1 <- plotlyLayout(NA, plotResids,
    log = "", nTicks = 4, digits = 0,
  ...
  p2 <- plotlyLayout(NA, plot.ratio.obs.pred,
    log = "", nTicks = 4, digits = 0,
    xTitle = "", xZeroLine = FALSE,
  ...
  p3 <- plotlyLayout(data$x.norm, data$plot.standardResids,
  ...
  p4 <- plotlyLayout(plotpredict, Resids2,
